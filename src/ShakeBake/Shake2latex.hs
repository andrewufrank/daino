...
<<<<<<< HEAD
        ...
        let test_template_out = fillTemplate_render testTempl metaplus5 

        -- putInform debug ["Panrep2 render html done", "ht1",  ht1 ]
        putInform debug ["Panrep2 render testTemplate done", "test_template",  test_template_out ]

        runErr2action $ do 
            write8 outP texFileType ( Latex ht1) 
            write8 outP ttlFileType test_template_out
