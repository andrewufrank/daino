...
import Lib.Pandoc (docValToAllVal, markdownToPandoc, pandocToContentHtml)-- with a simplified Action ~ ErrIO

import Lib.Templating (putValinMaster)
import Uniform.Pandoc (Pandoc, htmloutFileType, write8)
...
--test in bake_tests:
bakeOneFile debug pageFn doughP templatesP ht2 =
