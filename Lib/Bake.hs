...
--             when debug $ putIOwords ["bakeDocValue2html docval read "]

--             html2 <- putValinMaster False val (templatesDir layout)
--             write8 ht2 htmloutFileType html2

--             when debug $ putIOwords
--                 [ "bakeDocValue2html resultFile"
--                 , showT ht2
--                 , "from"
--                 , showT inputFn
--                 , "\n"
--                 ]
--             when debug $ putIOwords
--                 [ "bakeDocValue2html resultvalue"
--                 , take' 300 $ showT val
--                 , "\n"
--                 , take' 300 $ showT html2
--                 ]--   when debug $ 
--             putIOwords ["......................"]
...
--             pandoc2 :: Pandoc         <- markdownToPandocBiblio
--                 debug
--                 flags
--                 (doughDir layout)
--                 (pandoc, metaRec, report) -- AG -> AD
...
--             when debug $ putIOwords
--                 [ "bakeOneFile2texsnip resultFile"
--                 , showT texFn2
--                 , "from"
--                 , showT inputFn
--                 , "\n"
...
--                 , showT inputFn
--                 , "\n beomes pdfFn2"
--                 , showT pdfFn2   -- same input and pdffn2
--                 , "\n debug"
--                 , showT debug
--                 ]        -- both are from baked 
